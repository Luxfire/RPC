    ...
    /* [string][in] */ const char *szString)
{
    ...
    NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&ContextExample_StubDesc,
                  (PFORMAT_STRING) &ContextExample__MIDL_ProcFormatString.Format[94],
...
/* 108 */	0x0,		/* 0 */
			0x0,		/* 0 */
/* 110 */	NdrFcShort( 0x38 ),	/* 56 */
/* 112 */	NdrFcShort( 0x38 ),	/* 56 */
/* 114 */	0x42,		/* Oi2 Flags:  clt must size, has ext, */
			0x2,		/* 2 */
/* 116 */	0x8,		/* 8 */
			0x1,		/* Ext Flags:  new corr desc, */
...
/* 124 */	NdrFcShort( 0x118 ),	/* Flags:  in, out, simple ref, */
